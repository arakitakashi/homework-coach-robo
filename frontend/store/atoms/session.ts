...
import type { CharacterType, LearningProgress, Session, SessionStatus } from "@/types"
...
export const totalPointsAtom = atom((get) => {
	...
	return (
		progress.selfDiscoveryCount * 3 + progress.hintDiscoveryCount * 2 + progress.togetherCount * 1
	)
})
